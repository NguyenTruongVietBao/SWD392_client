...
export default function AdvertiserRegister() {
  ...
  const { isLoggingIn, user, registerAdvertiser } = useAuthStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await registerAdvertiser(formData);
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">Advertiser</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">Billing Info</span>
              </label>
              <input
                type="text"
                className={`input input-bordered w-full pl-10`}
